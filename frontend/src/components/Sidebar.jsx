...
import { Award, BookOpen, ChevronDown,CheckCircle, ChevronRight, Code, Coffee, Cpu, Database, Globe, Layout, Menu, Sparkles, Star, Target, Terminal, Trophy, X, Zap, XCircle } from "lucide-react";
...
const Sidebar = () => {
  ...
  const toggleSidebar = () => setIsSidebarOpen((prev) => !prev);   //toggle sidebar from small screen
